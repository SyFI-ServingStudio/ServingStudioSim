...
- `uv run python -m launcher alignment-campaign check --pack glm52_nvfp4_b200_spec5`: 0 errors; 7 provisional warnings at this checkpoint.
...
Eight cases currently have complete kernel/workload/E2E report sets. Cases09/10/13/14/15/16 E2E
are complete; one warm workload measurement and remaining report work are pending.
...
fourteen completed cases, backed by raw values and report hashes in its JSON sidecar.

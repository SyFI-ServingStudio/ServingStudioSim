...
- `uv run python -m launcher alignment-campaign check --pack glm52_nvfp4_b200_spec5`: 0 errors; 11 provisional warnings at this checkpoint.
...
Eight cases currently have complete kernel/workload/E2E report sets. Cases09/10/13/14 E2E
are complete; three warm workload measurements and remaining report work are pending.
...
twelve completed cases, backed by raw values and report hashes in its JSON sidecar.

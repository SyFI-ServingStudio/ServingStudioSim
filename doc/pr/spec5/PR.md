...
- `uv run python -m launcher alignment-campaign check --pack glm52_nvfp4_b200_spec5`: 0 errors; 9 provisional warnings at this checkpoint.
...
Eight cases currently have complete kernel/workload/E2E report sets. Cases09/10/13/14/15 E2E
are complete; two warm workload measurements and remaining report work are pending.
...
thirteen completed cases, backed by raw values and report hashes in its JSON sidecar.

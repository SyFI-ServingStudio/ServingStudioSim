...
impl VllmGlm52DenseFfnLocalWorklet {
    ...
    pub fn resolve_config(
        ...
        validate_config(cfg)
            .unwrap_or_else(|reason| panic!("invalid VllmGlm52DenseFfnLocalWorkletConfig: {reason}"));
...
fn worklet_label(name: &str, cfg: &VllmGlm52DenseFfnLocalWorkletConfig) -> String {
    format!(
        "{name} (VllmGlm52DenseFfnLocalWorklet) [local (1 GPU); hidden={}; intermediate={}]",
...
mod tests {
    ...
    fn input_shape_and_zero_case_feed_all_four_leaves_faithfully() {
        ...
        assert_eq!(VllmGlm52DenseFfnLocalWorkletInput::default().batch_tokens, 0);
    }

...
use crate::timing::kernels::{
    ...
    DsaIndexCacheAppendKernelInput, DsaIndexerQRopeQuantKernelInput,
    DsaMqaLogitsPrefillKernelInput, DsaPagedMqaLogitsDecodeKernelInput,
    DsaPersistentTopkDecodeKernelInput, DsaSparseIndexRemapKernelInput,
    DsaSparseMlaAttentionKernelInput, DsaSparseMlaPrefillKernelInput, DsaTopkPrefillKernelInput,
    ElementwiseKernelInput, FlashinferAttnDecodeKernelInput, FlashinferAttnRectKernelInput,
    Fp8BlockQuantKernelInput, Fp8BlockscaleGroupedGemmKernelInput,
    Fp8PerTokenGroupQuantKernelInput, GdnCausalConvDecodeKernelInput,
    GdnCausalConvPrefillKernelInput, GdnChunkDeltaRuleKernelInput, GdnChunkLocalCumsumKernelInput,
    GdnChunkOutputKernelInput, GdnChunkRecomputeWUKernelInput, GdnChunkScaledDotKktKernelInput,
    GdnChunkSolveTrilKernelInput, GdnChunkStateUpdateKernelInput, GdnGatedRmsNormKernelInput,
    GdnPrefillPostConvKernelInput, GdnRecurrentDecodeKernelInput, GemmFp32OutputKernelInput,
    GroupedGemmKernelInput, KvCacheAppendKernelInput, MhcRmsNormKernelInput,
    MlaCacheAppendKernelInput, MlaRopeQuantizeFp8KernelInput, MoeAlignBlockSizeKernelInput,
    MoeAlltoallKernelInput, MoeAlltoallPrepareKernelInput, MoeEpCollectiveKernelInput,
    MoeFinalizeFuseSharedKernelInput, MoeFinalizeRoutingKernelInput, MoeFusedTopkKernelInput,
    MoeSumKernelInput, MoeTopkSoftplusSqrtKernelInput, Mxfp4MarlinMoeGemmKernelInput,
    Nvfp4FusedMoeKernelInput, Nvfp4QuantKernelInput, P2pInterKernelInput, P2pIntraKernelInput,
    ResidualRmsNormKernelInput, RmsNormKernelInput, SingleGemmKernelInput, VllmFusedMoeKernelInput,

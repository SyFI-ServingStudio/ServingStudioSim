...
use crate::timing::kernels::{
    ...
    GemmFp32OutputKernelInput, GroupedGemmKernelInput, KdaChunkPrefillKernelInput,
    KvCacheAppendKernelInput, LogitsTopkKernelInput, MhcRmsNormKernelInput,
...
log_inputs! {
    ...
    KdaChunkPrefill => KdaChunkPrefillKernelInput,

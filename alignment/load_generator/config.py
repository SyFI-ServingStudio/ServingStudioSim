...
class SessionFrontendConfig:
    ...
    path: str
    context_policy: str = "trace_reported"

    def __post_init__(self) -> None:
        supported_policies = {"trace_reported", "monotonic"}
        if self.context_policy not in supported_policies:
            raise ValueError(
                "unsupported frontend.context_policy "
                f"{self.context_policy!r}; available: {sorted(supported_policies)}"
            )

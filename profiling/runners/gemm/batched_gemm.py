"""Production-layout Torch runner for GLM-5.2 MLA Q absorption.

The timed callable is only the unquantized ``torch.bmm(..., out=...)`` launch.
Layout construction mirrors vLLM v0.23.0 commit
``0fc695fc6d1d82e9a5ac6835ac8e4e1c83703665`` in
``mla_attention.py`` and ``process_weights_after_loading``.
"""
